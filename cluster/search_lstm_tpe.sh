#!/bin/bash
#SBATCH --job-name=opt_lstm_tpe_v2
...
#SBATCH --output=/cfs/earth/scratch/paleslui/DL_SS26/logs/opt_lstm_tpe_v2_%j.out
#SBATCH --error=/cfs/earth/scratch/paleslui/DL_SS26/logs/opt_lstm_tpe_v2_%j.err
