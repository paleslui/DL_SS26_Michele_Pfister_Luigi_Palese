#!/bin/bash
#SBATCH --job-name=opt_cnn_random_v2
...
#SBATCH --output=/cfs/earth/scratch/paleslui/DL_SS26/logs/opt_cnn_random_v2_%j.out
#SBATCH --error=/cfs/earth/scratch/paleslui/DL_SS26/logs/opt_cnn_random_v2_%j.err
